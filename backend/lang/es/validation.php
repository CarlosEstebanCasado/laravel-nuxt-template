...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducciones de los mensajes de validación estándar de Laravel.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado aparece en una filtración de datos. Elige un :attribute diferente.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes personalizar mensajes específicos para atributos/reglas.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Nombres amigables para sustituir :attribute en los mensajes.
    |
    */
